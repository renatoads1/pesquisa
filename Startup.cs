...
namespace pesquisa
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<pesquisaContext>(options =>
                    options.UseMySql(Configuration.GetConnectionString("pesquisaContext"), builder => builder.MigrationsAssembly("pesquisa")));
            services.AddDbContext<roboshomologacaoContext>(options =>
